            ...
            <Grid item md={7} sm={12} xs={12}>
              ...
              <Link sx={{ color: "black" }} href="#description">
                <Typography variant="body2" sx={styles.readMoreGrid}>
                  ...
                  intra-spray technology formulated to directly deliver iron
                  into the bloodstream, bypassing the primary processing by the
                  digestive system and thus preventing digestive discomfort
                  experienced from ingested iron supplements while also
        ...
        <Grid item md={12}>
          <Paper elevation={7} sx={styles.lowerPaper} id="description">
            ...
            <Typography fontSize={"1.9em"} textAlign="justify">
              Iron oral spray is an effective intra-spray technology formulated
              to directly deliver iron into the bloodstream, bypassing the
              primary processing by the digestive system and thus preventing
              digestive discomfort experienced from ingested iron supplements
              while also enhancing bioavailability. The tiny droplets absorb
              quickly, providing fast nutrient uptake.
              <br /> <br /> Iron is an essential mineral. Most of the iron in
              the body is found in the hemoglobin of red blood cells and in the
              myoglobin of muscle cells. Iron is vital for transporting oxygen
              and carbon dioxide. It is highly regarded for its role in
              supporting a healthy immune system, treating anemia, boosting
              hemoglobin, reducing tiredness and supporting a normal cognitive
              function.
            </Typography>
