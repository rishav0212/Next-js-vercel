                ...
                <Grid container spacing={16}>
                    <Grid item xs={12} sm={12} md={8} lg={8}>
                        <Typography className="d-flex align-self-center lh-lg" textAlign={"justify"}>
                            ...
                            We would again like to thank the Team of UBM medica who worked so hard to keep the arrangements good for all of us to enjoy this event and take maximum benefit out of it.
                        </Typography>
                    </Grid>
